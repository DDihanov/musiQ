...
public class ScrobbleTrackUseCase extends BaseUseCase<Scrobble, Response> {
    @Inject
    public ScrobbleTrackUseCase(LastFmApiClient lastFmApiClient, SigGenerator sigGenerator, UserSettingsRepository userSettingsRepository) {
